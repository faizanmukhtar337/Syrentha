    ...
    try {
        ...
        try {
            ...
            if (thumb) {
                await sock.sendMessage(chatId, {
                    image: { url: thumb },
                    caption: `*${captionTitle}*\nꜱʏʀᴇɴᴛʜᴀ Downloading Thia File...`
                }, { quoted: message });
            }
        ...
        try {
            ...
            if (meta?.success && meta?.result?.download_url) {
                ...
                await sock.sendMessage(chatId, { text: '*ꜱʏʀᴇɴᴛʜᴀ* Failed to fetch video from the API.' }, { quoted: message });
                return;
            }
        } catch (e) {
        ...
        try {
            ...
            if (err.response && err.response.status === 403) {
                ...
                await sock.sendMessage(chatId, { text: '*ꜱʏʀᴇɴᴛʜᴀ* Failed to download the video file.' }, { quoted: message });
                return;
            }
        }
        ...
        if (download403) {
            ...
            try {
                ...
                await sock.sendMessage(chatId, { text: '*ꜱʏʀᴇɴᴛʜᴀ* Failed to download the video file from alternate CDN.' }, { quoted: message });
                return;
            }
        }
        if (!buffer || buffer.length < 1024) {
            await sock.sendMessage(chatId, { text: '*ꜱʏʀᴇɴᴛʜᴀ*Downloaded file is empty or too small.' }, { quoted: message });
            return;
        }
