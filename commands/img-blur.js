...
async function blurCommand(sock, chatId, message, quotedMessage) {
    try {
        ...
        if (quotedMessage) {
            ...
            if (!quotedMessage.imageMessage) {
                await sock.sendMessage(chatId, { 
                    text: 'ꜱʏʀᴇɴᴛʜᴀ! ❌ Please reply to an image message' 
                });
                return;
            }
            ...
            await sock.sendMessage(chatId, { 
                text: 'ꜱʏʀᴇɴᴛʜᴀ! ❌ Please reply to an image or send an image with caption .blur' 
            });
            return;
        }
        ...
        await sock.sendMessage(chatId, { 
            text: 'ꜱʏʀᴇɴᴛʜᴀ! ❌ Failed to blur image. Please try again later.' 
        });
    }
}
