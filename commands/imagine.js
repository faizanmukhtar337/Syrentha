    ...
    try {
        ...
        if (!imagePrompt) {
            await sock.sendMessage(chatId, {
                text: 'ꜱʏʀᴇɴᴛʜᴀ! Please provide a prompt for the image generation.\nExample: .imagine a beautiful sunset over mountains'
            }, {
                quoted: message
            });
            return;
        ...
        await sock.sendMessage(chatId, {
            text: 'ꜱʏʀᴇɴᴛʜᴀ! 🎨 Generating your image... Please wait.'
        }, {
            quoted: message
        });
        ...
        await sock.sendMessage(chatId, {
            image: imageBuffer,
            caption: `ꜱʏʀᴇɴᴛʜᴀ! 🎨 Generated image for prompt: "${imagePrompt}"`
        }, {
            quoted: message
        });
        ...
        await sock.sendMessage(chatId, {
            text: 'ꜱʏʀᴇɴᴛʜᴀ! ❌ Failed to generate image. Please try again later.'
        }, {
            quoted: message
        });
    }
