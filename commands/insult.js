    ...
    try {
        ...
        if (!userToInsult) {
            await sock.sendMessage(chatId, { 
                text: 'ꜱʏʀᴇɴᴛʜᴀ! Please mention someone or reply to their message to insult them!'
            });
            return;
        }
        ...
        if (error.data === 429) {
            ...
            try {
                await sock.sendMessage(chatId, { 
                    text: 'ꜱʏʀᴇɴᴛʜᴀ! Please try again in a few seconds.'
                });
            } catch (retryError) {
            ...
            try {
                await sock.sendMessage(chatId, { 
                    text: 'ꜱʏʀᴇɴᴛʜᴀ! An error occurred while insulting.'
                });
            } catch (sendError) {
