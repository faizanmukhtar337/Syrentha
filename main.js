...
global.channelLink = "https://www.whatsapp.com/channel/0029Vb6WJ1IL2AU658NaxT2Q";
global.ytch = "ꜱʏʀᴇɴᴛʜᴀ";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363419270392244@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363419270392244@newsletter';
